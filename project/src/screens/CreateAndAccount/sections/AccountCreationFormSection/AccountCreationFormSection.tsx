      ...
      <div className="flex flex-col items-center justify-center gap-[72px] w-full max-w-[715px] mx-auto py-[62px] px-4">
        <header className="flex flex-col items-center justify-center gap-0.5">
          ...
          <p className="[font-family:'Poppins',Helvetica] font-normal text-base tracking-[0] leading-[normal]">
            ...
            <button className="text-[#111111] underline hover:no-underline">
              Log in
            </button>
          </p>
        </header>
        ...
        <form className="flex flex-col items-start gap-10 w-full">
          ...
          <div className="flex flex-col items-start gap-2 w-full">
            ...
            <Button
              type="submit"
              disabled
              className="w-full h-16 bg-[#111111] rounded-[40px] text-[#fff9f9] text-[22px] [font-family:'Poppins',Helvetica] font-medium tracking-[0] leading-[normal] opacity-25 hover:opacity-25"
            >
              Create an account
            </Button>
          </div>
