                        ...
                        <div className="p-8 grid grid-cols-2 gap-8 max-h-[60vh] overflow-y-auto">
                            <div className="space-y-6">
                                <div className="space-y-1.5">
                                    ...
                                    <a href={`mailto:${selectedCandidate.email}?subject=Regarding Your Skill Assessment`} className="font-bold text-gray-800 text-[13px] hover:text-blue-600 transition-colors cursor-pointer">{selectedCandidate.email}</a>
                                </div>
                                <div className="space-y-1.5">
