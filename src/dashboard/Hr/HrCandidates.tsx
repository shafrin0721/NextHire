                        ...
                        <form onSubmit={handleSendMessage} className="p-6 space-y-5 overflow-y-auto flex-1">
                            <div className="grid grid-cols-1 gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                ...
                                <div>
                                    ...
                                    <a href={`mailto:${selectedCandidate.email}?subject=Message from NextHire HR`} className="font-bold text-gray-800 text-sm mt-1 hover:text-blue-600 transition-colors block cursor-pointer">{selectedCandidate.email}</a>
                                </div>
                            </div>
                            {messageSentSuccess ? (
