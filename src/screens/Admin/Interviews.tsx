...
export const Interviews = (): JSX.Element => {
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
            <div className="bg-white rounded-[28px] w-full max-w-2xl overflow-hidden shadow-2xl">
                <div className="p-7 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-blue-50 to-white">
                    ...
                    <button onClick={() => { setScheduleModal(false); setEditModal(false); }} className="p-2 hover:bg-white rounded-xl border border-transparent hover:border-gray-100 transition-all text-gray-400">
                        <X className="w-6 h-6" />
                    </button>
                </div>
                <form onSubmit={onSubmit} className="p-7 space-y-5 max-h-[70vh] overflow-y-auto">
                    <div className="grid grid-cols-2 gap-5">
                        <div className="space-y-1.5">
                            ...
                            <input required value={form.candidate} onChange={e => setForm(f => ({ ...f, candidate: e.target.value }))} placeholder="e.g. John Smith" className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm font-semibold placeholder:text-gray-300 outline-none focus:ring-4 focus:ring-blue-50 transition-all" />
                        </div>
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Job Position</label>
                            <input required value={form.position} onChange={e => setForm(f => ({ ...f, position: e.target.value }))} placeholder="e.g. Senior Developer" className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm font-semibold placeholder:text-gray-300 outline-none focus:ring-4 focus:ring-blue-50 transition-all" />
                        </div>
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Interview Date</label>
                            <input required type="date" value={form.date} onChange={e => setForm(f => ({ ...f, date: e.target.value }))} className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm font-semibold outline-none focus:ring-4 focus:ring-blue-50 transition-all" />
                        </div>
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Interview Time</label>
                            <input required type="time" value={form.time} onChange={e => setForm(f => ({ ...f, time: e.target.value }))} className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm font-semibold outline-none focus:ring-4 focus:ring-blue-50 transition-all" />
                        </div>
                        <div className="space-y-1.5">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input required value={form.interviewer} onChange={e => setForm(f => ({ ...f, interviewer: e.target.value }))} placeholder="e.g. Dr. Smith" className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm font-semibold placeholder:text-gray-300 outline-none focus:ring-4 focus:ring-blue-50 transition-all" />
                        </div>
                    </div>
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Location / Meeting Link</label>
                        <input required value={form.location} onChange={e => setForm(f => ({ ...f, location: e.target.value }))} placeholder="e.g. zoom.us/j/... or Room 4B" className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm font-semibold placeholder:text-gray-300 outline-none focus:ring-4 focus:ring-blue-50 transition-all" />
                    </div>
                    <div className="space-y-1.5">
                    ...
                    <div className="flex gap-4 pt-2">
                        <button type="button" onClick={() => { setScheduleModal(false); setEditModal(false); }} className="flex-1 py-3.5 border border-gray-200 rounded-xl text-xs font-black text-gray-500 hover:bg-gray-50 transition-all tracking-widest uppercase">Cancel</button>
            ...
            <header className="h-16 bg-white border-b border-gray-100 flex items-center sticky top-0 z-30">
                <div className="w-full px-6 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            onClick={() => { setForm(emptyForm); setScheduleModal(true); }}
                    ...
                    <nav className="flex-1 px-4 py-6 flex flex-col gap-1">
                        {sidebarItems.map((item) => (
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeItem === item.label ? "bg-blue-50 text-blue-600 shadow-sm" : "text-gray-500 hover:bg-gray-50 hover:text-gray-900"}`}
                            >
